...
public abstract class FondNode extends DecapitatedJetNode {
  private final static long C3__FOND = 0x646e_6f66L;

  @Specialization
  protected Object fond(Object cor,
                        Object way,
                        Object hyp,
    ...
    try {
      ...
      // flag.
      long cacheId = 141 + C3__FOND + (Atom.requireLong(vet) << 8);
